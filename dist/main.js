...
todoSubmit.addEventListener("click", () => {
   ...
   //localStorage.setItem('home', JSON.stringify([...home, todoContainer().addToDo([`${title}`], [`${prioritys}`], [`${format(parseISO(dates), 'MMMM d')}`], [`${details}`])]));
    home.push(todoContainer().addToDo(title, prioritys, (0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])((0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(dates), 'MMMM d'), details));
